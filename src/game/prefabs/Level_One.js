...
class Level_One extends Phaser.GameObjects.Layer {
	...
	constructor(scene) {
		...
		// player
		const player = scene.add.container(528, 2560);
		...
		// mouth_11
		const mouth_11 = new Mouth(scene, NaN, 0);
		mouth_11.scaleX = 1;
		mouth_11.scaleY = 1;
		...
		// mouth_16
		const mouth_16 = new Mouth(scene, NaN, 0);
		mouth_16.scaleX = 1;
		mouth_16.scaleY = 1;
		container_2.add(mouth_16);

		// mouth_17
		const mouth_17 = new Mouth(scene, NaN, 0);
		mouth_17.scaleX = 1;
		mouth_17.scaleY = 1;
		...
		// mouth_12
		const mouth_12 = new Mouth(scene, NaN, 0);
		mouth_12.scaleX = 1;
		mouth_12.scaleY = 1;
		...
		// mouth_23
		const mouth_23 = new Mouth(scene, NaN, 0);
		mouth_23.scaleX = 1;
		mouth_23.scaleY = 1;
		...
		// mouth_26
		const mouth_26 = new Mouth(scene, NaN, 2277);
		mouth_26.scaleX = 1;
		mouth_26.scaleY = 1;
